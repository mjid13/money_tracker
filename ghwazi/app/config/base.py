...
class Config:
    ...
    BANK_EMAIL_ADDRESSES = os.environ.get('BANK_EMAIL_ADDRESSES', 'bankmuscat@bankmuscat.com').split(',')
    BANK_EMAIL_SUBJECTS = os.environ.get('BANK_EMAIL_SUBJECTS', 'transaction,alert,notification').split(',')
