...
class CategoryService:
    ...
    def get_category(self, category_id: int, user_id: int) -> Optional[Category]:
        ...
        try:
            ...
            try:
                category = CategoryRepository.get_category(session, category_id, user_id)
                return category
            finally:
                self.db.close_session(session)
        except Exception as e:
    ...
    def delete_category(self, category_id: int, user_id: int) -> bool:
        ...
        try:
            ...
            try:
                result = CategoryRepository.delete_category(session, category_id, user_id)
                return result
            finally:
                self.db.close_session(session)
        except Exception as e:
    ...
    def create_category_mapping(self, category_id: int, user_id: int, mapping_type: CategoryType, pattern: str) -> Optional[CategoryMapping]:
        ...
        try:
            ...
            try:
                mapping = CategoryRepository.create_category_mapping(session, category_id, user_id, mapping_type, pattern)
                return mapping
            finally:
                self.db.close_session(session)
        except Exception as e:
    ...
    def delete_category_mapping(self, mapping_id: int, user_id: int) -> bool:
        ...
        try:
            ...
            try:
                result = CategoryRepository.delete_category_mapping(session, mapping_id, user_id)
                return result
            finally:
                self.db.close_session(session)
        except Exception as e:
    ...
    def get_category_mappings(self, category_id: int, user_id: int) -> List[CategoryMapping]:
        ...
        try:
            ...
            try:
                mappings = CategoryRepository.get_category_mappings(session, category_id, user_id)
                return mappings
            finally:
                self.db.close_session(session)
        except Exception as e:
    ...
    def categorize_transaction(self, transaction_id: int, category_id: int, user_id: int) -> Optional[Transaction]:
        """
        ...
        try:
            ...
            try:
                transaction = CategoryRepository.categorize_transaction(session, transaction_id, category_id, user_id)
                return transaction
            finally:
                self.db.close_session(session)
        except Exception as e:
